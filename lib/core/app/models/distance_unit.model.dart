...
enum DistanceUnitModel {
  ...
  const DistanceUnitModel(this.symbol, this.name);
  ...
  static DistanceUnitModel fromLocale(String localeCode) {
    ...
    switch (countryCode) {
      case 'US': // États-Unis
      case 'GB': // Royaume-Uni
        return DistanceUnitModel.miles;
    }
    ...
    switch (languageCode) {
      ...
      default:
        ...
        return DistanceUnitModel.kilometers;
    }
  }

  /// Retourne une unité de distance à partir de son symbole
  static DistanceUnitModel fromSymbol(String symbol) {
    return DistanceUnitModel.values.firstWhere(
      (unit) => unit.symbol == symbol,
      orElse: () => DistanceUnitModel.kilometers,
    );
  }
}
